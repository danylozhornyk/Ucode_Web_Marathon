...
export const CreatePost: React.FC<UserProps> = ({ user }) => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            await PostService.createPost(title, content, image, selectedCategories);
            navigation('/'); 
    ...
    return (
        <div className="w-full min-h-screen bg-gray-900 text-gray-200 flex justify-center items-center">
            <div className="container mx-auto px-4 py-6 bg-gray-800 rounded-lg shadow-lg space-y-6 w-full max-w-4xl">
                <h1 className="text-4xl font-extrabold text-center mb-8">Create New Post</h1>
                {error && (
